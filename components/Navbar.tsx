  ...
  return (
    <nav className="bg-white  min-h-screen" id="home">
      <header className="bg-white sticky top-0 shadow dark:bg-gray-800">
        <div className="container flex items-center justify-center p-6 mx-auto text-gray-700 font-extrabold capitalize dark:text-gray-300">
          {/* <a
          href="#"
        ...
        >
          ...
          <Link>
            <a href="/">
              <p className="font-extrabold text-1xl md:text-3xl lg:text-5xl​ hover:text-blue-500">
